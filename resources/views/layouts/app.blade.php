...
<head>
    ...
    <title>@yield('title', 'Quản Lý Thiết Bị') - Hệ Thống</title>
...
<body>
                    ...
                    <nav class="mt-2">
                        <ul class="nav sidebar-menu flex-column" role="navigation">
                            @if(auth()->user()->isAdmin() || auth()->user()->isManager())
                                ...
                                <li class="nav-item">
                                    <a class="nav-link {{ Route::is('admin.equipment.*') ? 'active' : '' }}" href="{{ route('admin.equipment.index') }}">
                                        <i class="bi bi-laptop"></i> Thiết Bị
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link {{ Route::is('admin.borrowing.*') ? 'active' : '' }}" href="{{ route('admin.borrowing.index') }}">
                                        <i class="bi bi-hand-index"></i> Yêu Cầu Mượn
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link {{ Route::is('admin.borrowing.renewals') ? 'active' : '' }}" href="{{ route('admin.borrowing.renewals') }}" style="padding-left: 2rem;">
                                        <i class="bi bi-arrow-repeat"></i> Gia Hạn
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link {{ Route::is('admin.borrowing.returns') ? 'active' : '' }}" href="{{ route('admin.borrowing.returns') }}" style="padding-left: 2rem;">
                                        <i class="bi bi-box-arrow-left"></i> Trả Thiết Bị
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link {{ Route::is('admin.incidents.*') ? 'active' : '' }}" href="{{ route('admin.incidents.index') }}">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link {{ Route::is('admin.reports.utilization') ? 'active' : '' }}" href="{{ route('admin.reports.utilization') }}">
                                        <i class="bi bi-graph-up"></i> Sử Dụng Thiết Bị
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link {{ Route::is('admin.reports.borrowing') ? 'active' : '' }}" href="{{ route('admin.reports.borrowing') }}">
                                        <i class="bi bi-pie-chart"></i> Phân Tích Mượn
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link {{ Route::is('admin.reports.violations') ? 'active' : '' }}" href="{{ route('admin.reports.violations') }}">
                                        <i class="bi bi-ban"></i> Vi Phạm
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link {{ Route::is('admin.reports.penalties') ? 'active' : '' }}" href="{{ route('admin.reports.penalties') }}">
                                        <i class="bi bi-file-earmark-text"></i> Phí Phạt
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link {{ Route::is('admin.reports.employee-borrowing') ? 'active' : '' }}" href="{{ route('admin.reports.employee-borrowing') }}">
                            ...
                            @else
                                ...
                                <li class="nav-item">
                                    <a class="nav-link {{ Route::is('employee.equipment.*') ? 'active' : '' }}" href="{{ route('employee.equipment.browse') }}">
                                        <i class="bi bi-laptop"></i> Thiết Bị
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link {{ Route::is('employee.borrowings.*') ? 'active' : '' }}" href="{{ route('employee.borrowings.index') }}">
                                        <i class="bi bi-hand-index"></i> Yêu Cầu Mượn
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link {{ Route::is('employee.incidents.*') ? 'active' : '' }}" href="{{ route('employee.incidents.index') }}">
    ...
    <!-- Table Manager JS -->
    <script src="{{ asset('js/table-manager.js') }}"></script>
